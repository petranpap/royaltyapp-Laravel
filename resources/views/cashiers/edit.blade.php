                                ...
                                <div class="bg-white p-1 w-full">
                                 ...
                                 font-bold text-gray-600">Email</label>
                                            ...
                                            <input type="text" id="email" name="email" placeholder="Email"
                                                   class="cursor-not-allowed flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400 text-gray-600 placeholder-gray-400 outline-none"
                                                   value="{{ $cashier->email }}" disabled>
                                        </div>
