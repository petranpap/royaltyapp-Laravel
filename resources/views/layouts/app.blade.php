    ...
    <div class="flex flex-col w-full px-4 py-8 overflow-y-auto border-b lg:border-r lg:h-screen lg:w-64">
        ...
        <div class="flex flex-col justify-between mt-6">
            <aside>
                <ul>
                    <li>
                        <a class="flex items-center px-4 py-2 text-gray-700 rounded-md hover:bg-gray-200" id="clients_menu" href="/clients">
                    ...
                    <li>
                        <a class="flex items-center px-4 py-2 text-gray-700 rounded-md hover:bg-gray-200" id="lifetime_points_menu" href="/clients/lifetime_points">
                            <img src="/icons/lifetime_points.png" width="35">

                            <span class="mx-4 font-medium">Clients LifeTime Points</span>
                        </a>
                    </li>
