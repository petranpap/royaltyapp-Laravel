                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                        ...
                        <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400 " id='table_users'>
                            ...
                            <tbody>
                            @foreach ($lifetime_points as $lifetime_point)
                            <tr class="bg-white border-b hover:bg-teal-100 hover:text-black dark:border-white-700 text-sm text-black">
                                <td class="py-4 px-6"> {{ $lifetime_point->fname }} {{ $lifetime_point->lname }}</td>
                                <td class="py-4 px-6"> {{ $lifetime_point->phone_1 }}</td>
                                <td class="py-4 px-6"> {{ $lifetime_point->phone_2 }}</td>
                                <td class="py-4 px-6"> {{ $lifetime_point->points }}</td>
                                <td>
                                    <a class="btn btn-primary" href="/clients/edit/{{ $lifetime_point->id}}"><img src="/icons/view.png" width="50"></a>
...
<script>
    $("li:not(#lifetime_points_menu)").removeClass("bg-gray-100 border-double border-4 border-yellow-600");
    $("#lifetime_points_menu").addClass("bg-gray-100 border-double border-4 border-yellow-600");
