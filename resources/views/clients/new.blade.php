<x-app-layout>
    ...
    <div class="w-full h-full p-4 m-8 overflow-y-auto">
        ...
        <form id="add-form" action="{{ url('/clients/add').'/'.Auth::user()->id }}" method="Post"  >
            @csrf
            @method('POST')
