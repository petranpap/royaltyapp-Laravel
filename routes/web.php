...
Route::post('/clients/add', [App\Http\Controllers\ClientsController::class, 'store']);
Route::put('update-client/{id}/{authid}', [App\Http\Controllers\ClientsController::class, 'update']);
Route::put('redeem-client/{id}', [App\Http\Controllers\ClientsController::class, 'redeem']);
